...
import { getComparator, stableSort } from '../util/util.js'
...
const ListCert = () => {
    ...
    const emptyRows =
        page > 0 ? Math.max(0, (1 + page) * rowsPerPage - allRequests.length) : 0;
    ...
    return (
        ...
        <Box sx={{ width: '100%' }}>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="center">
                                            <IconButton color="secondary" aria-label="add an alarm" onClick={() => setOpenDialog(!openDialog)}>
                                                <VisibilityIcon />
                                            </IconButton>
                                        </TableCell>
                                    </TableRow>
            ...
            <FullScreenDialog open={openDialog} onClose={()=> setOpenDialog(false)} />
            </>
    );
}
